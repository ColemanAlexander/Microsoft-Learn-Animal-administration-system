                ...
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    if (ourAnimals[i, 2] == "Age: ?")
                    {
                        ...
                        do
                        {
                            ...
                            Console.WriteLine($"Update animal age for {ourAnimals[i, 0]} ");
                            var result = Console.ReadLine();
                            success = int.TryParse(result, out ageResult);

                        } while (!success);

                        ourAnimals[i, 2] = "Age: " + ageResult;
                    }
                    ...
                    if (ourAnimals[i, 4] == "Physical description: ")
                    {
                        ...
                        do
                        {
                            ...
                            Console.WriteLine($"Update animal description for {ourAnimals[i, 0]} (size, color, breed, gender, weight, housebroken)");
                            phyResult = Console.ReadLine();

                            if (!String.IsNullOrEmpty(phyResult))
                            {
                                success = true;
                            }

                        } while (!success);
                        ourAnimals[i, 4] = $"Physical description: {phyResult}";
                    }
                   ...
                   if (ourAnimals[i, 3] == "Nickname: ")
                    {
                        ...
                        do
                        {
                            ...
                            Console.WriteLine($"Update animal nickname for {ourAnimals[i, 0]}");
                            nicResult = Console.ReadLine();

                            if (!String.IsNullOrEmpty(nicResult))
                            {
                                success = true;
                            }

                        } while (!success);
                        ourAnimals[i, 3] = $"Nickname: {nicResult}";
                    }
                    ...
                    if (ourAnimals[i, 5] == "Personality: ")
                    {
                        ...
                        do
                        {
                            ...
                            Console.WriteLine($"Update animal personality for {ourAnimals[i, 0]} (likes or dislikes, tricks, energy level)");
                            perResult = Console.ReadLine();

                            if (!String.IsNullOrEmpty(perResult))
                            {
                                success = true;
                            }

                        } while (!success);
                        ourAnimals[i, 5] = $"Personality: {perResult}";
                    }
